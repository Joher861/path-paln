...
struct TrajectoryMsg_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::planning_planner::TrajectoryPointMsg_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::planning_planner::TrajectoryPointMsg_<ContainerAllocator> >::other >  _trajectory_type;
  ...
  typedef boost::shared_ptr< ::planning_planner::TrajectoryMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::planning_planner::TrajectoryMsg_<ContainerAllocator> const> ConstPtr;

}; // struct TrajectoryMsg_

typedef ::planning_planner::TrajectoryMsg_<std::allocator<void> > TrajectoryMsg;

typedef boost::shared_ptr< ::planning_planner::TrajectoryMsg > TrajectoryMsgPtr;
typedef boost::shared_ptr< ::planning_planner::TrajectoryMsg const> TrajectoryMsgConstPtr;
