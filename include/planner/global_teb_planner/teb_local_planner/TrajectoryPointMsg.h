...
struct TrajectoryPointMsg_
{
  ...
  typedef boost::shared_ptr< ::planning_planner::TrajectoryPointMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::planning_planner::TrajectoryPointMsg_<ContainerAllocator> const> ConstPtr;

}; // struct TrajectoryPointMsg_

typedef ::planning_planner::TrajectoryPointMsg_<std::allocator<void> > TrajectoryPointMsg;

typedef boost::shared_ptr< ::planning_planner::TrajectoryPointMsg > TrajectoryPointMsgPtr;
typedef boost::shared_ptr< ::planning_planner::TrajectoryPointMsg const> TrajectoryPointMsgConstPtr;
