...
struct TrajectoryMsg_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::planning_controller::TrajectoryPointMsg_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::planning_controller::TrajectoryPointMsg_<ContainerAllocator> >::other >  _trajectory_type;
  ...
  typedef boost::shared_ptr< ::planning_controller::TrajectoryMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::planning_controller::TrajectoryMsg_<ContainerAllocator> const> ConstPtr;

}; // struct TrajectoryMsg_

typedef ::planning_controller::TrajectoryMsg_<std::allocator<void> > TrajectoryMsg;

typedef boost::shared_ptr< ::planning_controller::TrajectoryMsg > TrajectoryMsgPtr;
typedef boost::shared_ptr< ::planning_controller::TrajectoryMsg const> TrajectoryMsgConstPtr;
...
// // {'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg'], 'teb_local_planner': ['/home/book/catkin_ws/src/teb_local_planner/msg'], 'costmap_converter': ['/opt/ros/kinetic/share/costmap_converter/cmake/../msg']}
