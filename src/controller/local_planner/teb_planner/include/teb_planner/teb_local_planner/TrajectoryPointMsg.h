...
struct TrajectoryPointMsg_
{
  ...
  _acceleration_type acceleration;
   ...
   typedef double _time_from_start_type;   //ros::Duration用double替换
  ...
  typedef boost::shared_ptr< ::planning_controller::TrajectoryPointMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::planning_controller::TrajectoryPointMsg_<ContainerAllocator> const> ConstPtr;

}; // struct TrajectoryPointMsg_

typedef ::planning_controller::TrajectoryPointMsg_<std::allocator<void> > TrajectoryPointMsg;

typedef boost::shared_ptr< ::planning_controller::TrajectoryPointMsg > TrajectoryPointMsgPtr;
typedef boost::shared_ptr< ::planning_controller::TrajectoryPointMsg const> TrajectoryPointMsgConstPtr;
