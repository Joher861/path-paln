...
#include <global_teb_planner/teb_local_planner/optimal_planner.h>
...
public:
  ...
  void computeError()
  {
    ...
    {
      dist_to_obstacle = robot_model_->calculateDistance(conf1->pose());
    }
    else
    {
      dist_to_obstacle = robot_model_->calculateDistance(conf1->pose(), _measurement);
    }
