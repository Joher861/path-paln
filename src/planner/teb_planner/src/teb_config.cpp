...
DEFINE_CONFIG_READ_FUNC(TebGoalTolerance)
	...
	READ_CONFIG_MEMBER(controller_patience)
...
{ 
    ...
    if(footprint_ptr)
    {
      ...
      footprint.foot_str = "[[1.05, -0.3],[1.05, 0.3], [-0.15,0.3],[-0.15,-0.3]]";
    ...
    if(goal_tolerance_ptr)
    {
      ...
      goal_tolerance.controller_patience = goal_tolerance_ptr->controller_patience;
      ...
      printf("controller_patience:%lf\r\n",goal_tolerance_ptr->controller_patience);
    ...
    else
    {
      ...
      goal_tolerance.controller_patience = 20;
    }
    ...
    if(obstacles_ptr)
    {
      ...
      printf("use_sdf_map:%d\r\n",obstacles_ptr->use_sdf_map);
    ...
    if(hcp_ptr)
    {
      ...
      hcp.selection_kinematics_cost_scale = hcp_ptr->selection_kinematics_cost_scale;
      ...
      hcp.use_astar = hcp_ptr->use_astar;
      ...
      printf("selection_kinematics_cost_scale:%d\r\n",hcp_ptr->selection_kinematics_cost_scale);
    ...
    else
    {
      ...
      hcp.selection_kinematics_cost_scale = 10.0;
